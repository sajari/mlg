...
func (*Example) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{0} }
...
func (*SequenceExample) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{1} }
...
func init() { proto.RegisterFile("tensorflow/core/example/example.proto", fileDescriptor25) }
